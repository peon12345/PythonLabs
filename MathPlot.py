...
class MathPlot(Drawable):
    _lines = Lines()
    numPos = namedtuple("numPos", ["num", "pos"])
    ...
    def __init__(self, x_len, y_len, x_offset=0, y_offset=0):
        ...
        self._lines.add_line(Line(p1_x_line, p2_x_line))
        self._lines.add_line(Line(p1_y_line, p2_y_line))
        ...
        self._lines.add_line(Line(p1_x_line_arrow_up, p_x_arrow))
        self._lines.add_line(Line(p1_x_line_arrow_down, p_x_arrow))
        ...
        self._lines.add_line(Line(p1_y_line_arrow_left, p_y_arrow))
        self._lines.add_line(Line(p1_y_line_arrow_right, p_y_arrow))
    ...
    def __make_markup_lines(self, line_x, line_y):
        ...
        while right_line_x.p1.x < line_x.p2.x - interval:
            ...
            self._lines.add_line(Line(right_line_x.p1, right_line_x.p2, 2))
        ...
        while left_line_x.p1.x > 0:
            ...
            self._lines.add_line(Line(left_line_x.p1, left_line_x.p2, 2))
        ...
        while down_line_y.p2.y < line_y.p2.y:
            ...
            self._lines.add_line(Line(down_line_y.p1, down_line_y.p2, 2))
        ...
        while up_line_y.p1.y > interval:
            ...
            self._lines.add_line(Line(up_line_y.p1, up_line_y.p2, 2))
